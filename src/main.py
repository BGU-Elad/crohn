...
exec_sql = ExcelSQL([
    "../sensitive_data/data 010126.xlsx",#"../sensitive_data/for_tal/DB QA - rule 3 26.6- Female  Morning STAG .xlsx",#"../sensitive_data/for_tal/user_data.xlsx", # '../sensitive_data/_DB QA 1 - to upload 23.06.2025.xlsx', #'../sensitive_data/data April 3rd 2025.xlsx',
    "../sensitive_data/עותק של checkWork -26.8.2024.xlsx", # '../sensitive_data/debug/checkWork -26.8.2024.xlsx',
    "../sensitive_data/acount and passwords (2).xlsx",#"../sensitive_data/debug/acount and passwords2.xlsx",
    "../sensitive_data/messages after fixes V2.xlsx",    # "../sensitive_data/debug/messages.xlsx",
])
date = "22.12.2025"
exec_sql.create_table(date)
...
minus_days = (get_now(0).date() - datetime.strptime(date, "%d.%m.%Y").date()).days
