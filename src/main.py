...
exec_sql = ExcelSQL(['../sensitive_data/debug/data.xlsx', '../sensitive_data/debug/checkWork -26.8.2024.xlsx', "../sensitive_data/debug/acount and passwords.xlsx", "../sensitive_data/debug/messages.xlsx"])
