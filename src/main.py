...
exec_sql = ExcelSQL([
    "../sensitive_data/for_tal/DB QA - rule 2 25.6 - Female Morning  STAG WT.xlsx",#"../sensitive_data/for_tal/user_data.xlsx", # '../sensitive_data/_DB QA 1 - to upload 23.06.2025.xlsx', #'../sensitive_data/data April 3rd 2025.xlsx',
