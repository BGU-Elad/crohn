...
exec_sql = ExcelSQL([
    "../sensitive_data/DATA24-11-25.xlsx",#"../sensitive_data/for_tal/DB QA - rule 3 26.6- Female  Morning STAG .xlsx",#"../sensitive_data/for_tal/user_data.xlsx", # '../sensitive_data/_DB QA 1 - to upload 23.06.2025.xlsx', #'../sensitive_data/data April 3rd 2025.xlsx',
    "../sensitive_data/for_tal/app_data.xlsx", # '../sensitive_data/debug/checkWork -26.8.2024.xlsx',
    "../sensitive_data/acount and passwords.xlsx",#"../sensitive_data/debug/acount and passwords2.xlsx",
...
minus_days = (get_now(0).date() - datetime.strptime("23.11.2025 23:50:00", "%d.%m.%Y  %H:%M:%S").date()).days
